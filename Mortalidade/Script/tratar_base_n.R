...
library(foreign)
rt<- read.dbf("./DADOS/DO21OPEN.dbf")
...
validacao = sqldf("select sexo
                        , Chapter_desc
                        , ICD10_3_code_desc
                        , count(1) qtd
                    from base
                  where Chapter_desc = 'Certain infectious and parasitic diseases (A00-B99)'
                    and WHO_Full_desc LIKE '%Sepsis%'
                  group by sexo
                         , Chapter_desc
                         , ICD10_3_code_desc
                         ")
