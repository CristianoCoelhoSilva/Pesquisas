...
causa = fread("./DADOS/CAUSA/neoplasias.csv", encoding = "UTF-8")
...
porcentagem = sqldf("select ano_obito ANO, totalMortes.qtd, ROUND(((quantidade.qtd * 1000) / totalMortes.qtd),2) porcentagem from totalMortes inner join quantidade on totalMortes.ano_obito = quantidade.ANO")
