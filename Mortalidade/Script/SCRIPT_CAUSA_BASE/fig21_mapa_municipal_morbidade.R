...
base = sqldf("select codmunres, count(1) qtd_mortes from base where ano_obito = 2019 and  causabas_capitulo like '%XX.  Causas externas de morbidade e mortalidade%' group by codmunres")
