...
base = sqldf("select CODMUNRES, count(1) qtd_mortes from base where ano_obito = 2019 and  causabas_capitulo like '%IX.  Doenças do aparelho circulatório%' group by codmunres")
