...
base = sqldf("select codmunres, count(1) qtd_mortes from base where ano_obito = 2019 and  causabas_capitulo like '%X.   Doenças do aparelho respiratório%' group by codmunres")
